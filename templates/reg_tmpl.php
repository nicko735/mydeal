        ...
        <main class="content__main">
          ...
          <form class="form" action="register.php" method="post" autocomplete="off">
            ...
            <div class="form__row">
              ...
              <input class="form__input" type="password" name="password" id="password" value="<?= get_post_val('password') ?>" placeholder="Введите пароль">
            ...
            <div class="form__row">
              ...
              <input class="form__input" type="text" name="name" id="name" value="<?= get_post_val('name') ?>" placeholder="Введите имя">
